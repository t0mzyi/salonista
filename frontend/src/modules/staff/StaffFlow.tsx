      ...
      {activeBooking ? (
        <div className="card" style={{ 
          ...
          <div className="flex justify-between items-start" style={{ marginBottom: 12 }}>
            <div>
              <div style={{ fontFamily: 'Poppins, sans-serif', fontSize: 26, fontWeight: 700, color: '#fff' }}>
          ...
          <div key={b.id} className="card flex justify-between items-center" style={{ marginBottom: 0, padding: '16px 20px' }}>
            <div className="flex items-center gap-4">
              <div style={{
                ...
                fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: 18, color: 'var(--ink)',
              }}>#{i + 1}</div>
              <div>
        ...
        {showWalkin && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div
              ...
              <div className="h2" style={{ marginBottom: 6 }}>Add Walk-in</div>
              <div className="caption" style={{ marginBottom: 20 }}>Manually add a walk-in customer to the queue.</div>

              <div className="flex-col" style={{ gap: 14 }}>
                <div>
                  <div className="label" style={{ marginBottom: 6 }}>Customer Name (optional)</div>
                  <input type="text" className="input-field" placeholder="e.g. Rahul"
                    value={walkinName} onChange={e => setWalkinName(e.target.value)} />
                </div>
                <div>
                  <div className="label" style={{ marginBottom: 6 }}>Service</div>
                ...
                <button className="btn-primary" style={{ marginTop: 8 }}
                  onClick={() => { setWalkinName(''); setShowWalkin(false); }}>
                  Add to Queue
                </button>
  ...
  return (
    <motion.div initial="initial" animate="in" exit="out" variants={pageVariants} transition={pageTransition}
      ...
      <div className="card" style={{
        ...
        <div style={{ fontFamily: 'Poppins, sans-serif', fontSize: 40, fontWeight: 700, color: '#fff', lineHeight: 1 }}>
          ₹1,800
        </div>
      ...
      <div className="flex gap-3" style={{ marginBottom: 24 }}>
        <div className="card flex-col" style={{ flex: 1, marginBottom: 0, textAlign: 'center' }}>
          <div style={{ fontFamily: 'Poppins, sans-serif', fontSize: 34, fontWeight: 700, color: 'var(--ink)' }}>12</div>
          <div className="caption">Completed</div>
        </div>
        <div className="card flex-col" style={{ flex: 1, marginBottom: 0, textAlign: 'center' }}>
          <div style={{ fontFamily: 'Poppins, sans-serif', fontSize: 34, fontWeight: 700, color: 'var(--primary)' }}>2</div>
